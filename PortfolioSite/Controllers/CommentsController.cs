    ...
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PostId,Body")] Comment comment)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Details", "BlogPosts", new { slug = bp.Post.Slug });
            }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.SaveChanges();
            var grabSlug = db.Posts.Find(bp.PostId).Slug;
            return RedirectToAction("Details", "BlogPosts", new { slug = grabSlug });
        }
